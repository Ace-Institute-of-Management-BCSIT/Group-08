...
<button formaction="../status bar/accept_booking.php" type="submit">Accept Request</button>
<button class="danger" formaction="../status bar/reject_booking.php" type="submit">Reject Request</button>
</form>
<?php endif; ?>
<?php if (($role === 'Worker' || $role === 'Admin') && $booking['status'] === 'Accepted'): ?>
<form class="actions" action="../status bar/update_status.php" method="POST">
<input type="hidden" name="booking_id" value="<?php echo e($booking['booking_id']); ?>">
