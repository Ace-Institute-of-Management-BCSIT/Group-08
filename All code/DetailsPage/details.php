...
<p><strong><?php echo e($history['title']); ?></strong><br>Employer: <?php echo e($canViewContact ? ($history['employer_name'] ?: 'Employer') : 'Hidden'); ?><br>Completion: <?php echo e($history['completion_date'] ?: $history['updated_at']); ?><?php if ($history['rating']): ?><br>Rating: <?php echo e((int) $history['rating']); ?> star<?php endif; ?><?php if ($history['review_summary']): ?><br><?php echo e($history['review_summary']); ?><?php endif; ?></p>
<?php endforeach; ?>
</div>
...
<p><?php echo e((int) $review['rating']); ?> star <?php echo e($review['review_comment']); ?></p>
<?php endforeach; ?>
</div>
</aside>
</article>
